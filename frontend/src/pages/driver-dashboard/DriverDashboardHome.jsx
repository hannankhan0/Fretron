    ...
    >
      ...
      <section className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
        {[
          ...
          <article key={label} className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-800/50">
          ...
          <div className="mt-4 space-y-3">
            {data.recentRoutes.length === 0 ? (
              ...
              data.recentRoutes.map((item) => (
                <div key={item.id} className="rounded-2xl border border-slate-100 bg-slate-50 px-4 py-3 dark:border-slate-700 dark:bg-slate-800">
          ...
          <div className="mt-4 space-y-3">
            {data.recentBookings.length === 0 ? (
              ...
              data.recentBookings.map((item, index) => (
                <div key={`${item.booking_code}-${index}`} className="rounded-2xl border border-slate-100 bg-slate-50 px-4 py-3 dark:border-slate-700 dark:bg-slate-800">
