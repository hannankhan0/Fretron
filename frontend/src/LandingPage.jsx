    ...
    <div className="min-h-screen bg-white text-slate-900">
      <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/user-signup?redirect=/driver-signup"
              className="hidden text-sm font-medium text-slate-500 hover:text-slate-900 md:inline-flex"
            >
              Join as Driver
            </Link>
          ...
          <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-2 lg:items-center lg:px-8 lg:py-28">
            <div className="max-w-2xl">
              ...
              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                <Link
                  to="/user-signup?redirect=/user-dashboard/post-shipment"
                  className="rounded-2xl bg-blue-600 px-6 py-3 text-sm font-medium text-white shadow-lg shadow-blue-600/20 transition hover:bg-blue-700 text-center"
                >
                  Post a Shipment
                </Link>

                <Link
                  to="/user-login?redirect=/user-dashboard/browse-routes"
                  className="rounded-2xl border border-slate-300 bg-white px-6 py-3 text-sm font-medium text-slate-700 shadow-sm transition hover:border-slate-400 hover:bg-slate-50 text-center"
                >
...
<Link to="/user-signup">Sign Up</Link>
              <Link to="/user-signup?redirect=/driver-signup">Join as Driver</Link>
